  ...
  return (
    <div className={`mb-3 px-1 ${size}`}>
      ...
      <input
        ...
        value={value}
        onChange={change}
        className={`bg-white text-gray-400 outline-none shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline`}
